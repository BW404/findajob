...
$page_title = 'Create Job Seeker Account - FindAJob Nigeria';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="register-container">
        <div class="register-left">
            <div class="register-content">
                ...
                <p>Join Nigeria's leading job platform and unlock thousands of opportunities waiting for you.</p>
                
                <ul class="benefits-list">
                    <li>Access to 10,000+ verified job postings</li>
                    <li>AI-powered job matching technology</li>
                    <li>Free professional CV builder</li>
                    <li>Direct communication with employers</li>
                    <li>Career guidance and skill development</li>
                    <li>Mobile app for job search on-the-go</li>
                </ul>
            </div>
        </div>
        ...
        <div class="register-right">
            <form class="register-form" id="registerForm">
                <div class="form-header">
                    <span class="user-type-badge">👤 Job Seeker Account</span>
                ...
                <div class="form-links">
                    <p>Already have an account? <a href="login-jobseeker.php">Sign in here</a></p>
                </div>
    ...
    <script>
        document.getElementById('registerForm').addEventListener('submit', async function(e) {
            ...
            formData.append('user_type', 'job_seeker');
            ...
            try {
                ...
                if (result.success) {
                    ...
                    setTimeout(() => {
                        window.location.href = 'login-jobseeker.php';
                    }, 3000);
                } else {
    ...
    <nav class="app-bottom-nav">
        ...
        <a href="register-jobseeker.php" class="app-bottom-nav-item active">
