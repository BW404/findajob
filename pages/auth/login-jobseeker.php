...
$page_title = 'Job Seeker Login - FindAJob Nigeria';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="login-container">
        <div class="login-left">
            <div class="login-content">
                ...
                <p>Join thousands of job seekers who found their perfect career match with FindAJob Nigeria.</p>
                
                <ul class="feature-list">
                    <li>Access to thousands of verified jobs</li>
                    <li>AI-powered job matching</li>
                    <li>Multiple CV management</li>
                    <li>Direct employer connections</li>
                    <li>Career guidance and training</li>
                </ul>
            </div>
        </div>
        ...
        <div class="login-right">
            <form class="login-form" id="loginForm">
                <div class="form-header">
                    <span class="user-type-badge">👤 Job Seeker</span>
                    <h2>Welcome Back!</h2>
                ...
                <div class="switch-user-type">
                    ...
                    <a href="login-employer.php">Switch to Employer Login</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <nav class="app-bottom-nav">
        ...
        <a href="login-jobseeker.php" class="app-bottom-nav-item active">
            <div class="app-bottom-nav-icon">👤</div>
