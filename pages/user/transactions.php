...
// Debug: Check user ID (REMOVE IN PRODUCTION)
error_log("Transactions page - User ID: " . $user_id);
        ...
        <div class="transactions-card">
            ...
            <?php if (empty($transactions)): ?>
                <div class="empty-state">
                    ...
                    <p>You haven't made any payments yet. Upgrade your plan to unlock premium features!</p>
                    ...
                    <div class="transaction-item">
                        <div class="transaction-main">
                            <div class="transaction-info">
                                <h4><?= htmlspecialchars($transaction['description'] ?? (!empty($transaction['service_type']) ? ucwords(str_replace('_', ' ', $transaction['service_type'])) : 'Payment')) ?></h4>
                                <div class="transaction-ref"><?= htmlspecialchars($transaction['tx_ref']) ?></div>
                            </div>
                        ...
                        <div class="transaction-meta">
                            ...
                            <span>
                                ...
                                <?= htmlspecialchars($transaction['payment_gateway'] ?? 'Flutterwave') ?>
                            </span>
